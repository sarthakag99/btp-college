...
const PostGraduate = () => (
    <div>
        ...
        <h1 className={styles.head} style={{ marginTop: '10px', marginBottom: '10px', padding: '5px', }}>Post Graduate</h1>
                <hr></hr>
                <br></br>
                ...
                <img alt="img1" src="uploadedFiles\Academics\ECE-Curriculum.jpg"></img><br></br>
                ...
                <img alt="img1" src="uploadedFiles\Academics\Mobile-Communication.jpg"></img><br></br>
                ...
                <img alt="img1" src="uploadedFiles\Academics\ECE-discipline.jpg"></img><br></br><br></br>
                ...
                <br></br>
                <img alt="img1" src="uploadedFiles\Academics\CCE-discipline.jpg"></img><br></br>
                
                </p>
                <a style={{ textAlign: 'left' }} target="_blank" href="uploadedFiles\Academics/ECE_PG_Curriculum_with_CIF.pdf">Semester-Wise Curriculum For PG in ECE Programme</a>    
